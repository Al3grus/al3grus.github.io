...
media_subpath: /images/THM_room_name/
image:
  path: image_example.webp
---
...
[![Tryhackme Room Link](image_example_2.webp){: width="300" height="300" .shadow}](https://tryhackme.com/room/mrrobot){: .center }
